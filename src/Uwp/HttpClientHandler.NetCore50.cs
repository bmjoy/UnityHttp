...
using StringWithQualityHeaderValue = UnityHttp.Net.Http.Headers.StringWithQualityHeaderValue;
    ...
    public class HttpClientHandler : HttpMessageHandler
    {
            ...
            set
            {
                ...
                if (!UseCookies)
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_invalid_enable_first: {0} - {1}", nameof(UseCookies), "true"));
                }
                CheckDisposedOrStarted();
            ...
            set
            {
                if (value != PreAuthenticate)
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(PreAuthenticate)));
                }
                CheckDisposedOrStarted();
            }
        }
        ...
        public ICredentials Credentials
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(Credentials)));
                }
            }
        }
        ...
        public ICredentials DefaultProxyCredentials
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(DefaultProxyCredentials)));
                }
            }
        }
        ...
        public int MaxAutomaticRedirections
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(MaxAutomaticRedirections)));
                }
                CheckDisposedOrStarted();
            }
        }
        ...
        public long MaxRequestContentBufferSize
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(MaxRequestContentBufferSize)));
                }
                CheckDisposedOrStarted();
            }
        }
        ...
        public int MaxResponseHeadersLength
        {
            ...
            {
                throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                    "net_http_value_not_supported: {0} - {1}", value, nameof(MaxResponseHeadersLength)));
            }
        }
        ...
        public Func<HttpRequestMessage, X509Certificate2, X509Chain, SslPolicyErrors, bool> ServerCertificateCustomValidationCallback
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(ServerCertificateCustomValidationCallback)));
                }
            }
        }
        ...
        public bool CheckCertificateRevocationList
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(CheckCertificateRevocationList)));
                }
            }
        }
        ...
        public SslProtocols SslProtocols
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException(String.Format(CultureInfo.InvariantCulture,
                        "net_http_value_not_supported: {0} - {1}", value, nameof(SslProtocols)));
                }
            }
        }
