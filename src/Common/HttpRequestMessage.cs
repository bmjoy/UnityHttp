    ...
    public class HttpRequestMessage : IDisposable
    {
        ...
        public Uri RequestUri
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("net_http_client_http_baseaddress_required", nameof(value));
                }
                CheckDisposed();
        ...
        private void InitializeValues(HttpMethod method, Uri requestUri)
        {
            ...
            {
                throw new ArgumentException("net_http_client_http_baseaddress_required", nameof(requestUri));
            }
