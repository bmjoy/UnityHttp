...
namespace UnityHttp.Net.Http.Headers
{
    public class ViaHeaderValue : ICloneable
    {
        ...
        private static void CheckReceivedBy(string receivedBy)
        {
            ...
            {
                throw new ArgumentException("net_http_argument_empty_string", nameof(receivedBy));
            }
            ...
            {
                throw new FormatException(string.Format(System.Globalization.CultureInfo.InvariantCulture, "net_http_headers_invalid_value", receivedBy));
            }
        }
    }
}
