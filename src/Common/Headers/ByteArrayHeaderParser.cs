...
namespace UnityHttp.Net.Http.Headers
{
    ...
    internal class ByteArrayHeaderParser : HttpHeaderParser
    {
        ...
        public override bool TryParseValue(string value, object storeValue, ref int index, out object parsedValue)
        {
            ...
            {
                UnityEngine.Debug.LogError(string.Format(System.Globalization.CultureInfo.InvariantCulture, "net_http_parser_invalid_base64_string: {0}", base64String, e.Message));
            }
