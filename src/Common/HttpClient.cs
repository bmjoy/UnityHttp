...
namespace UnityHttp.Net.Http
{
    public class HttpClient : HttpMessageInvoker
    {
        ...
        private static void CheckBaseAddress(Uri baseAddress, string parameterName)
        {
            ...
            {
                throw new ArgumentException("net_http_client_absolute_baseaddress_required", parameterName);
            }

            if (!HttpUtilities.IsHttpUri(baseAddress))
            {
                throw new ArgumentException("net_http_client_http_baseaddress_required", parameterName);
            }
        }
